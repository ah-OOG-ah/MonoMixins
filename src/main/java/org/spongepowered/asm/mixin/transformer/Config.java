...
public class Config {
   ...
   public static Config create(String configFile, MixinEnvironment outer) {
      return create(configFile, outer, null);
   }
   ...
   public static Config create(String configFile, MixinEnvironment outer, IMixinConfigSource source) {
      ...
      if (config != null) {
         ...
         try {
            ...
            throw new MixinInitialisationError("Error initialising mixin config " + configFile, var8);
         }
         ...
         if (config == null) {
            ...
            if (!Strings.isNullOrEmpty(parent)) {
               ...
               try {
                  ...
                  throw new MixinInitialisationError("Error initialising parent mixin config " + parent + " of " + configFile, var7);
               }
