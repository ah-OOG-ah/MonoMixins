...
public final class MemberInfo implements ITargetSelectorConstructor, ITargetSelectorRemappable {
   ...
   public boolean equals(Object obj) {
      if (obj != null && obj instanceof ITargetSelectorByName) {
         ...
         boolean otherForceField = other instanceof MemberInfo
            ? ((MemberInfo)other).forceField
            : (other instanceof ITargetSelectorRemappable ? ((ITargetSelectorRemappable)other).isField() : false);
         return this.compareMatches(other)
   ...
   private boolean compareMatches(ITargetSelectorByName other) {
      return other instanceof MemberInfo
         ? ((MemberInfo)other).matches.equals(this.matches)
         : this.getMinMatchCount() == other.getMinMatchCount() && this.getMaxMatchCount() == other.getMaxMatchCount();
   }
   ...
   public ITargetSelectorRemappable transform(String newDesc) {
      return (newDesc != null || this.desc != null) && (newDesc == null || !newDesc.equals(this.desc))
         ? new MemberInfo(this.name, this.owner, newDesc, this.matches)
         : this;
   }
