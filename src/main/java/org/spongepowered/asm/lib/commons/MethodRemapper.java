...
public class MethodRemapper extends MethodVisitor {
   ...
   public void visitInvokeDynamicInsn(String name, String descriptor, Handle bootstrapMethodHandle, Object... bootstrapMethodArguments) {
      ...
      if (this.remapper.api == 0) {
         remappedName = this.remapper.mapInvokeDynamicMethodName(name, descriptor);
      } else {
         remappedName = this.remapper.mapInvokeDynamicMethodName(name, descriptor, bootstrapMethodHandle, bootstrapMethodArguments);
      }
      ...
      super.visitInvokeDynamicInsn(
         remappedName, this.remapper.mapMethodDesc(descriptor), (Handle)this.remapper.mapValue(bootstrapMethodHandle), remappedBootstrapMethodArguments
      );
   }
