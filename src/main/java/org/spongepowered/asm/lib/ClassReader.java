...
public class ClassReader {
   ...
   ClassReader(byte[] classFileBuffer, int classFileOffset, boolean checkClassVersion) {
      ...
      if (checkClassVersion && this.readShort(classFileOffset + 6) > 70) {
   ...
   public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
      ...
      if (runtimeVisibleAnnotationsOffset != 0) {
         ...
         while (numAnnotations-- > 0) {
            ...
            currentAnnotationOffset = this.readElementValues(
               classVisitor.visitAnnotation(annotationDescriptor, true), currentAnnotationOffset, true, charBuffer
            );
         }
      }
      ...
      if (runtimeInvisibleAnnotationsOffset != 0) {
         ...
         while (numAnnotations-- > 0) {
            ...
            currentAnnotationOffset += 2;
            currentAnnotationOffset = this.readElementValues(
               classVisitor.visitAnnotation(annotationDescriptor, false), currentAnnotationOffset, true, charBuffer
            );
         }
      }
      ...
      if (runtimeVisibleTypeAnnotationsOffset != 0) {
         ...
         while (numAnnotations-- > 0) {
            ...
            currentAnnotationOffset += 2;
            currentAnnotationOffset = this.readElementValues(
               classVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, true),
      ...
      if (runtimeInvisibleTypeAnnotationsOffset != 0) {
         ...
         while (numAnnotations-- > 0) {
            ...
            currentAnnotationOffset += 2;
            currentAnnotationOffset = this.readElementValues(
               classVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, false),
               currentAnnotationOffset,
               true,
               charBuffer
            );
      ...
      if (innerClassesOffset != 0) {
         ...
         for (int currentClassesOffset = innerClassesOffset + 2; numberOfClasses-- > 0; currentClassesOffset += 8) {
            classVisitor.visitInnerClass(
               this.readClass(currentClassesOffset, charBuffer),
               this.readClass(currentClassesOffset + 2, charBuffer),
               this.readUTF8(currentClassesOffset + 4, charBuffer),
               this.readUnsignedShort(currentClassesOffset + 6)
            );
         }
      }
      ...
      if (recordComponentVisitor == null) {
         ...
         if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  recordComponentVisitor.visitAnnotation(annotationDescriptor, true), currentAnnotationOffset, true, charBuffer
               );
            }
         }
         ...
         if (runtimeInvisibleAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  recordComponentVisitor.visitAnnotation(annotationDescriptor, false), currentAnnotationOffset, true, charBuffer
               );
            }
         }
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset = this.readElementValues(
                  recordComponentVisitor.visitTypeAnnotation(
                     context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, true
                  ),
                  currentAnnotationOffset,
                  true,
                  charBuffer
         ...
         if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset = this.readElementValues(
                  recordComponentVisitor.visitTypeAnnotation(
                     context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, false
                  ),
                  currentAnnotationOffset,
                  true,
                  charBuffer
      ...
      if (fieldVisitor == null) {
         ...
         if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  fieldVisitor.visitAnnotation(annotationDescriptor, true), currentAnnotationOffset, true, charBuffer
               );
            }
         }
         ...
         if (runtimeInvisibleAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  fieldVisitor.visitAnnotation(annotationDescriptor, false), currentAnnotationOffset, true, charBuffer
               );
            }
         }
         ...
         if (runtimeVisibleTypeAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  fieldVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, true),
                  currentAnnotationOffset,
                  true,
                  charBuffer
               );
         ...
         if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  fieldVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, false),
                  currentAnnotationOffset,
                  true,
                  charBuffer
               );
   ...
   private int readMethod(ClassVisitor classVisitor, Context context, int methodInfoOffset) {
      ...
      MethodVisitor methodVisitor = classVisitor.visitMethod(
         ...
         signatureIndex == 0 ? null : this.readUtf(signatureIndex, charBuffer),
         exceptions
      );
      if (methodVisitor == null) {
         ...
         if (methodVisitor instanceof MethodWriter) {
            ...
            if (methodWriter.canCopyMethodAttributes(
               this,
               synthetic,
               (context.currentMethodAccessFlags & 131072) != 0,
               this.readUnsignedShort(methodInfoOffset + 4),
               signatureIndex,
               exceptionsOffset
            )) {
         ...
         if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  methodVisitor.visitAnnotation(annotationDescriptor, true), currentAnnotationOffset, true, charBuffer
               );
            }
         }
         ...
         if (runtimeInvisibleAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  methodVisitor.visitAnnotation(annotationDescriptor, false), currentAnnotationOffset, true, charBuffer
               );
            }
         }
         ...
         if (runtimeVisibleTypeAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  methodVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, true),
                  currentAnnotationOffset,
                  true,
                  charBuffer
               );
         ...
         if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            ...
            while (numAnnotations-- > 0) {
               ...
               currentAnnotationOffset += 2;
               currentAnnotationOffset = this.readElementValues(
                  methodVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, false),
                  currentAnnotationOffset,
                  true,
                  charBuffer
               );
      ...
      if (codeLength > this.classFileBuffer.length - currentOffset) {
         ...
         while (attributesCount-- > 0) {
            ...
            if ("LocalVariableTable".equals(attributeName)) {
               ...
               Attribute attribute = this.readAttribute(
                  context.attributePrototypes, attributeName, currentOffset, attributeLength, charBuffer, codeOffset, labels
               );
               attribute.nextAttribute = attributes;
               attributes = attribute;
            }
            ...
            for (int offset = stackMapFrameOffset; offset < stackMapTableEndOffset - 2; offset++) {
               if (classBuffer[offset] == 8) {
                  ...
                  if (potentialBytecodeOffset >= 0
                     ...
                     && (classBuffer[bytecodeStartOffset + potentialBytecodeOffset] & 255) == 187) {
         ...
         while (currentOffset < bytecodeEndOffset) {
            ...
            while (stackMapFrameOffset != 0 && (context.currentFrameOffset == currentBytecodeOffset || context.currentFrameOffset == -1)) {
               if (context.currentFrameOffset != -1) {
                  if (compressedFrames && !expandFrames) {
                     ...
                     methodVisitor.visitFrame(
                        -1, context.currentFrameLocalCount, context.currentFrameLocalTypes, context.currentFrameStackCount, context.currentFrameStackTypes
                     );
                  }
            ...
            for (;
               ...
               currentVisibleTypeAnnotationBytecodeOffset = this.getTypeAnnotationBytecodeOffset(
               ...
               if (currentVisibleTypeAnnotationBytecodeOffset == currentBytecodeOffset) {
                  ...
                  this.readElementValues(
                     methodVisitor.visitInsnAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, true),
                     currentAnnotationOffset,
                     true,
                     charBuffer
                  );
            ...
            for (;
               ...
               currentInvisibleTypeAnnotationBytecodeOffset = this.getTypeAnnotationBytecodeOffset(
   ...
   private int[] readTypeAnnotations(MethodVisitor methodVisitor, Context context, int runtimeTypeAnnotationsOffset, boolean visible) {
      ...
      for (int i = 0; i < typeAnnotationsOffsets.length; i++) {
         ...
         if (targetType >>> 24 == 66) {
            ...
            String annotationDescriptor = this.readUTF8(currentOffset, charBuffer);
            currentOffset += 2;
            currentOffset = this.readElementValues(
               methodVisitor.visitTryCatchAnnotation(targetType & -256, path, annotationDescriptor, visible), currentOffset, true, charBuffer
            );
         } else {
   ...
   private int getTypeAnnotationBytecodeOffset(int[] typeAnnotationOffsets, int typeAnnotationIndex) {
      return typeAnnotationOffsets != null
            && typeAnnotationIndex < typeAnnotationOffsets.length
            && this.readByte(typeAnnotationOffsets[typeAnnotationIndex]) >= 67
         ? this.readUnsignedShort(typeAnnotationOffsets[typeAnnotationIndex] + 1)
         : -1;
   }
   ...
   private int readElementValue(AnnotationVisitor annotationVisitor, int elementValueOffset, String elementName, char[] charBuffer) {
      if (annotationVisitor == null) {
         ...
         switch (this.classFileBuffer[elementValueOffset] & 0xFF) {
            case 64:
               currentOffset = this.readElementValues(
                  annotationVisitor.visitAnnotation(elementName, this.readUTF8(currentOffset, charBuffer)), currentOffset + 2, true, charBuffer
               );
               break;
            case 65:
            case 69:
   ...
   private Attribute readAttribute(
      Attribute[] attributePrototypes, String type, int offset, int length, char[] charBuffer, int codeAttributeOffset, Label[] labels
   ) {
      if (length > this.classFileBuffer.length - offset) {
         throw new IllegalArgumentException();
      } else {
   ...
   public long readLong(int offset) {
      ...
      long l0 = this.readInt(offset + 4) & 4294967295L;
      return l1 << 32 | l0;
   }
