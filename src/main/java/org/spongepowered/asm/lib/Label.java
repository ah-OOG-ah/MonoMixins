...
public class Label {
   ...
   final void addSubroutineRetSuccessors(Label subroutineCaller) {
      ...
      while (listOfBlocksToProcess != EMPTY_LIST) {
         Label var5 = listOfBlocksToProcess.nextListElement;
         listOfBlocksToProcess.nextListElement = listOfProcessedBlocks;
         listOfProcessedBlocks = listOfBlocksToProcess;
         if ((listOfBlocksToProcess.flags & 64) != 0 && listOfBlocksToProcess.subroutineId != subroutineCaller.subroutineId) {
            listOfBlocksToProcess.outgoingEdges = new Edge(
               listOfBlocksToProcess.outputStackSize, subroutineCaller.outgoingEdges.successor, listOfBlocksToProcess.outgoingEdges
            );
         }

         listOfBlocksToProcess = listOfBlocksToProcess.pushSuccessors(var5);
      }
