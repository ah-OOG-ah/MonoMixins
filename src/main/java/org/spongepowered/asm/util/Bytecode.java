...
public final class Bytecode {
         ...
         if (node instanceof JumpInsnNode) {
            ...
            out = out
               + String.format(
                  ...
                  idc.name,
                  idc.desc,
                  getOpcodeName(idc.bsm.getTag(), Printer.HANDLE_TAG),
                  idc.bsm.getOwner(),
                  idc.bsm.getName(),
                  idc.bsm.getDesc()
               );
   ...
   public static void setVisibility(ClassNode classNode, Bytecode.Visibility visibility) {
   ...
   public static void compareBridgeMethods(MethodNode a, MethodNode b) {
      ...
      if (ia.hasNext()) {
         throw new SyntheticBridgeException(SyntheticBridgeException.Problem.BAD_LENGTH, a.name, a.desc, index, ia.next(), null);
      } else if (ib.hasNext()) {
         throw new SyntheticBridgeException(SyntheticBridgeException.Problem.BAD_LENGTH, a.name, a.desc, index, null, ib.next());
      }
   }
