...
class AnnotatedMixin implements IMixinContext, IAnnotatedElement {
            ...
            if (!this.targets.contains(type)) {
               if (this.virtual) {
                  ...
                  this.printMessage(
                     ...
                     "Mixin target " + softTarget + " could not be fully resolved.",
                  ...
                  this.printMessage(
                     IMessagerEx.MessageType.MIXIN_SOFT_TARGET_IS_PUBLIC,
                     "Mixin target " + softTarget + " is public and " + must + " be specified in value",
                     suppressedBy
                  );
   ...
   public void registerInjector(ExecutableElement method, AnnotationHandle inject, InjectorRemap remap) {
      this.removeMethod(method);
      AnnotatedMixinElementHandlerInjector.AnnotatedElementInjector injectorElement = new AnnotatedMixinElementHandlerInjector.AnnotatedElementInjector(
         method, inject, this, remap
      );
   ...
   public void registerInjectionPoint(
      ExecutableElement element, AnnotationHandle inject, String selectorCoordinate, AnnotationHandle at, InjectorRemap remap, String format
   ) {
      this.injectors
         .registerInjectionPoint(
            new AnnotatedMixinElementHandlerInjector.AnnotatedElementInjectionPoint(element, inject, this, selectorCoordinate, at, remap), format
         );
   }
   ...
   public void registerSliceInjectionPoint(
      ...
      this.injectors
         .registerInjectionPoint(
            new AnnotatedMixinElementHandlerInjector.AnnotatedElementSliceInjectionPoint(element, inject, this, selectorCoordinate, at, remap, parentContext),
            format
         );
   }
