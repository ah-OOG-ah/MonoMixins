...
public interface IMixinAnnotationProcessor extends IMessagerSuppressible, IOptionProvider {
   ...
   public static enum CompilerEnvironment {
      ...
      public static IMixinAnnotationProcessor.CompilerEnvironment detect(ProcessingEnvironment processingEnv) {
         for (IMixinAnnotationProcessor.CompilerEnvironment environment : values()) {
