...
public final class Lists {
   ...
   public static <T> List<List<T>> partition(List<T> list, int size) {
      ...
      return (List<List<T>>)(list instanceof RandomAccess ? new Lists.RandomAccessPartition<>(list, size) : new Lists.Partition<>(list, size));
   }
   ...
   public static <T> List<T> reverse(List<T> list) {
      if (list instanceof ImmutableList) {
         ...
         return (List<T>)(list instanceof RandomAccess ? new Lists.RandomAccessReverseList<>(list) : new Lists.ReverseList<>(list));
      }
   }
