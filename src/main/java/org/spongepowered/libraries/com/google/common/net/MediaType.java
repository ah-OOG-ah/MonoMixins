package org.spongepowered.libraries.com.google.common.net;
...
import org.spongepowered.libraries.com.google.common.base.Ascii;
import org.spongepowered.libraries.com.google.common.base.CharMatcher;
import org.spongepowered.libraries.com.google.common.base.Charsets;
...
import org.spongepowered.libraries.com.google.common.collect.ImmutableMultiset;
import org.spongepowered.libraries.com.google.common.collect.ImmutableSet;
import org.spongepowered.libraries.com.google.common.collect.Iterables;
...
import org.spongepowered.libraries.com.google.errorprone.annotations.concurrent.LazyInit;
...
public final class MediaType {
   ...
   private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.of(
   ...
   private String computeToString() {
      ...
      if (!this.parameters.isEmpty()) {
         builder.append("; ");
         Multimap<String, String> quotedParameters = Multimaps.transformValues(this.parameters, new Function<String, String>() {
