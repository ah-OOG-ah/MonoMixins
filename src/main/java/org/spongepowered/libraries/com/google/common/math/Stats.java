...
import org.spongepowered.libraries.com.google.common.primitives.Doubles;
   ...
   public String toString() {
      return this.count() > 0L
         ? MoreObjects.toStringHelper(this)
            ...
            .add("mean", this.mean)
            .add("populationStandardDeviation", this.populationStandardDeviation())
            .add("min", this.min)
            .add("max", this.max)
            .toString()
         : MoreObjects.toStringHelper(this).add("count", this.count).toString();
   }
