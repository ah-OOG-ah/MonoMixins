...
public final class Multimaps {
   ...
   public static <K, V> Multimap<K, V> newMultimap(
      Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends Collection<V>> factory
   ) {
      return new Multimaps.CustomMultimap<>(map, factory);
   }

   public static <K, V> ListMultimap<K, V> newListMultimap(
      Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends List<V>> factory
   ) {
      return new Multimaps.CustomListMultimap<>(map, factory);
   }

   public static <K, V> SetMultimap<K, V> newSetMultimap(
      Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends Set<V>> factory
   ) {
      return new Multimaps.CustomSetMultimap<>(map, factory);
   }

   public static <K, V> SortedSetMultimap<K, V> newSortedSetMultimap(
      Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends SortedSet<V>> factory
   ) {
   ...
   private static <V> Collection<V> unmodifiableValueCollection(Collection<V> collection) {
      if (collection instanceof SortedSet) {
         ...
         return (Collection<V>)(collection instanceof List
            ? Collections.unmodifiableList((List<? extends V>)collection)
   ...
   public static <K, V1, V2> Multimap<K, V2> transformValues(
      Multimap<K, V1> fromMultimap, org.spongepowered.libraries.com.google.common.base.Function<? super V1, V2> function
   ) {
   ...
   public static <K, V1, V2> ListMultimap<K, V2> transformValues(
      ListMultimap<K, V1> fromMultimap, org.spongepowered.libraries.com.google.common.base.Function<? super V1, V2> function
   ) {
      Preconditions.checkNotNull(function);
      Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
      return transformEntries(fromMultimap, transformer);
   ...
   static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
      ...
      class EntrySet extends Maps.EntrySet<K, Collection<V>> {
         ...
         public Iterator<Entry<K, Collection<V>>> iterator() {
            return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new org.spongepowered.libraries.com.google.common.base.Function<K, Collection<V>>() {
   ...
   private static class CustomListMultimap<K, V> extends AbstractListMultimap<K, V> {
      transient org.spongepowered.libraries.com.google.common.base.Supplier<? extends List<V>> factory;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomListMultimap(Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends List<V>> factory) {
         super(map);
      ...
      private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
         ...
         this.factory = (org.spongepowered.libraries.com.google.common.base.Supplier<? extends List<V>>)stream.readObject();
   ...
   private static class CustomMultimap<K, V> extends AbstractMapBasedMultimap<K, V> {
      transient org.spongepowered.libraries.com.google.common.base.Supplier<? extends Collection<V>> factory;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomMultimap(Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends Collection<V>> factory) {
         super(map);
         this.factory = Preconditions.checkNotNull(factory);
      }
      ...
      private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
         stream.defaultReadObject();
         this.factory = (org.spongepowered.libraries.com.google.common.base.Supplier<? extends Collection<V>>)stream.readObject();
         Map<K, Collection<V>> map = (Map<K, Collection<V>>)stream.readObject();
         this.setMap(map);
      }
   }
   ...
   private static class CustomSetMultimap<K, V> extends AbstractSetMultimap<K, V> {
      transient org.spongepowered.libraries.com.google.common.base.Supplier<? extends Set<V>> factory;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomSetMultimap(Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends Set<V>> factory) {
         super(map);
         this.factory = Preconditions.checkNotNull(factory);
      }
      ...
      private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
         stream.defaultReadObject();
         this.factory = (org.spongepowered.libraries.com.google.common.base.Supplier<? extends Set<V>>)stream.readObject();
         Map<K, Collection<V>> map = (Map<K, Collection<V>>)stream.readObject();
         this.setMap(map);
      }
   }
   ...
   private static class CustomSortedSetMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
      transient org.spongepowered.libraries.com.google.common.base.Supplier<? extends SortedSet<V>> factory;
      transient Comparator<? super V> valueComparator;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomSortedSetMultimap(Map<K, Collection<V>> map, org.spongepowered.libraries.com.google.common.base.Supplier<? extends SortedSet<V>> factory) {
         super(map);
         this.factory = Preconditions.checkNotNull(factory);
      ...
      private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
         stream.defaultReadObject();
         this.factory = (org.spongepowered.libraries.com.google.common.base.Supplier<? extends SortedSet<V>>)stream.readObject();
   ...
   private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
      ...
      Collection<V2> transform(K key, Collection<V1> values) {
         org.spongepowered.libraries.com.google.common.base.Function<? super V1, V2> function = Maps.asValueToValueFunction(this.transformer, key);
         return (Collection<V2>)(values instanceof List ? Lists.transform((List<V1>)values, function) : Collections2.transform(values, function));
      }
      ...
      public Map<K, Collection<V>> asMap() {
         ...
         if (result == null) {
            result = this.map = Collections.unmodifiableMap(
               Maps.transformValues(this.delegate.asMap(), new org.spongepowered.libraries.com.google.common.base.Function<Collection<V>, Collection<V>>() {
