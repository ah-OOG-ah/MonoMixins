...
import org.spongepowered.libraries.com.google.common.primitives.UnsignedLongs;
...
public final class LongMath {
   ...
   private static final long[][] millerRabinBaseSets = new long[][]{
   ...
   public static long saturatedPow(long b, int k) {
      ...
      if (b >= -2L & b <= 2L) {
         ...
         long accum = 1L;
         long limit = Long.MAX_VALUE + (b >>> 63 & (k & 1));
