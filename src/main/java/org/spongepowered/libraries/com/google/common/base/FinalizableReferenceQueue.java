...
public class FinalizableReferenceQueue implements Closeable {
   ...
   private static final String FINALIZER_CLASS_NAME = "org.spongepowered.libraries.com.google.common.base.internal.Finalizer";
   ...
   static class DecoupledLoader implements FinalizableReferenceQueue.FinalizerLoader {
      ...
      public Class<?> loadFinalizer() {
         try {
            ...
            return finalizerLoader.loadClass("org.spongepowered.libraries.com.google.common.base.internal.Finalizer");
      ...
      URL getBaseUrl() throws IOException {
         String finalizerPath = "org.spongepowered.libraries.com.google.common.base.internal.Finalizer".replace('.', '/') + ".class";
   ...
   static class DirectLoader implements FinalizableReferenceQueue.FinalizerLoader {
      ...
      public Class<?> loadFinalizer() {
         try {
            return Class.forName("org.spongepowered.libraries.com.google.common.base.internal.Finalizer");
      ...
      public Class<?> loadFinalizer() {
         if (disabled) {
            ...
            if (systemLoader != null) {
               try {
                  return systemLoader.loadClass("org.spongepowered.libraries.com.google.common.base.internal.Finalizer");
