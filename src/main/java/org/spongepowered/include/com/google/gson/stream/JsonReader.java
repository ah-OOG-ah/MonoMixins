   ...
   public double nextDouble() throws IOException {
      ...
      if (p == 15) {
         ...
         if (p == 16) {
            ...
            throw new IllegalStateException(
               "Expected a double but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
            );
         }
         ...
         if (this.lenient || !Double.isNaN(result) && !Double.isInfinite(result)) {
            ...
            throw new MalformedJsonException(
               "JSON forbids NaN and infinities: " + result + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
            );
         }
      }
   }
   ...
   public long nextLong() throws IOException {
      ...
      if (p == 15) {
         ...
         if (p == 16) {
            ...
            if (p != 8 && p != 9) {
               throw new IllegalStateException(
                  "Expected a long but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
               );
            }
         ...
         public void promoteNameToValue(JsonReader reader) throws IOException {
            if (reader instanceof JsonTreeReader) {
               ...
               if (p == 13) {
                  ...
                  if (p != 14) {
                     throw new IllegalStateException(
                        "Expected a name but was " + reader.peek() + " " + " at line " + reader.getLineNumber() + " column " + reader.getColumnNumber()
                     );
                  }
