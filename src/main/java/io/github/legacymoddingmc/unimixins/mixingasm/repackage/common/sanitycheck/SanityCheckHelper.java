...
import io.github.legacymoddingmc.unimixins.mixingasm.repackage.common.config.ConfigUtil;
import java.net.URL;
...
public class SanityCheckHelper {
   ...
   public static void showBigWarning(List<String>... warningses) {
      ...
      if (!allWarnings.isEmpty()) {
         ...
         LOGGER.fatal("======================================================================================");
         throw new Error(String.join("; ", allWarnings));
      }
   }
   ...
   public static List<String> checkIfJarPrefixesExist(List<String> concerningPrefixes) {
      ...
      return !concerningJars.isEmpty() ? Arrays.asList("Detected incompatible jars: " + concerningJars) : Arrays.asList();
   }
